    ...
    <div class="flex flex-col w-full px-6 py-6 justify-between">
      <div class="border-2 border-neutral-200 h-auto mb-6 w-full py-12 px-40">
        ...
        <div class="flex flex-col justify-self-start">
          <div class="font-poppins font-semibold my-2 text-xl">FIRST NAME</div>
          <input class="w-full mb-6 rounded-md font-poppins text-xl h-16" placeholder="Enter your first name" type="text" required>
          <div class="font-poppins font-semibold my-2 text-xl">LAST NAME</div>
          <input class="w-full rounded-md font-poppins text-xl mb-6 h-16" placeholder="Enter your last name" type="text" required>
          <div class="font-poppins font-semibold my-2 text-xl">EMAIL ADDRESS</div>
          <input class="w-full mb-6 rounded-md font-poppins text-xl h-16" placeholder="Enter your email address" type="text" required>
          <div class="font-poppins font-semibold my-2 text-xl">VALID ID TYPE</div>
          <input class="w-full rounded-md font-poppins text-xl mb-1 h-16" placeholder="Select Valid ID" type="text" required>
        </div>
        <a href="{{ url('etanom/signup/details/id') }}">
