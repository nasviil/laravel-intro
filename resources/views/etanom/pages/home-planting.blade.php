...
<section class="h-full flex-grow flex flex-col py-8 pr-14 pl-72 mr-[24%] mt-20">
  <div class="text-normal text-4xl font-semibold mb-4">Hello Roel. <span class="opacity-50 font-normal ml-2">Welcome Back!</span></div>
  <div class="flex justify-between gap-6">
    <a href="{{ url('etanom/home/orders') }}" class="w-[33%]">
      <button class="w-full bg-white h-28 border border-light_active text-light_active rounded-lg flex items-center px-6">
    ...
    <a href="{{ url('etanom/home/planting') }}" class="w-[33%]">
      <button class="w-full h-28 border border-normal_active bg-normal_active text-white rounded-lg flex items-center px-6">
  ...
  <div class="bg-white rounded-b-md">
    <div class="px-14 border-t-8 border-normal p-2 flex justify-between">
      <div class="font-semibold text-xl">02LFPKW32<span class="font-normal border-l border-neutral-200 px-2 ml-2">Roel S. Bayola</span></div>
      <div class="text-normal text-xl">IN PROGRESS</div>
    </div>
    <div class="px-14 border-t border-neutral-300 flex justify-between py-4">
      <div class="flex">
        <img src="{{ asset('img/Rectangle_220.png') }}" alt="" class="mr-2">
        <div>
          <p class="text-2xl font-semibold tracking-wide">Birch Tree</p>
      ...
      <p class="text-xl text-normal">P159</p>
    </div>
    <div class="px-14 border-t border-neutral-300 flex justify-between py-6">
      <div>
        <button class="py-2 px-4 text-xl bg-dark_active text-white mr-4">View more items</button> <span class="text-neutral-400 text-xl">7 items</span>
        <p class="text-neutral-400 text-lg mt-6">Upload an image before you proceed.</p>
      </div>
      <div class="flex flex-col items-end">
        <div>
          <p class="text-xl">Order Total: <span class="ml-4 text-2xl font-bold text-normal">P1,632</span></p>
        </div>
        <button class="bg-accept hover:bg-accept_hover text-xl text-white px-8 py-3 mt-6 rounded-md flex items-center ">
