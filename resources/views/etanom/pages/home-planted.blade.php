...
<section class="h-full flex-grow flex flex-col py-8 pr-14 pl-72 mr-[24%] mt-20">
  ...
  <div class="bg-white rounded-b-md">
    <div class="px-14 border-t-8 border-normal p-2 flex justify-between">
      ...
      <div class="text-normal text-xl">COMPLETED <span class="font-bold border-l border-neutral-200 px-2">JUNE 32, 2029</span></div>
    </div>
    ...
    <div class="px-14 border-t border-neutral-300 flex justify-between py-6">
      ...
      <div class="flex flex-col items-end">
        ...
        <div class="bg-accept opacity-50 text-xl text-white px-8 py-3 mt-6 rounded-md flex items-center">PAYMENT RECEIVED
        </div>
      </div>
    </div>
  </div>
