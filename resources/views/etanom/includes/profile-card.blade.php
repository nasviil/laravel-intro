...
<head>
  ...
  <section class="fixed right-0 h-full w-[25%] rounded-tl-3xl bg-white mt-24">
    <div class="pb-8 border-b border-neutral-200">
      ...
      <div class="flex justify-end w-full px-8 py-4">
        <a href="{{ url('/etanom/profile/info') }}">
          <button class="bg-dark_active px-3 py-4 rounded-lg mr-6">
            <img src="{{ asset('img/View.png') }}" alt="" class="h-5 w-7">
          </button>
        </a>
        <a href="{{ url('/etanom/profile/edit/info') }}" class="">
          <button class="bg-dark_active flex text-white items-center px-2 h-12 rounded-lg text-xl gap-3">
    ...
    <div class="border-b border-neutral-200 px-4 py-8">
      <div class="flex w-full bg-light rounded-xl p-4 items-center justify-between">
        <div class="h-full flex flex-col items-center justify-center p-2 border-r border-neutral-200">
          <h1 class="text-4xl text-normal_active font-semibold">643</h1>
          <h2 class="text-lg text-darker">Trees Planted</h2>
        </div>
        <div class="h-full flex flex-col items-center justify-center p-2 border-r border-neutral-200">
          <h1 class="text-4xl text-normal_active font-semibold">38</h1>
          <h2 class="text-lg text-darker">Trees Planting</h2>
        </div>
        <div class="h-full flex flex-col items-center justify-center p-2">
          <h1 class="text-4xl text-normal_active font-semibold">219</h1>
          <h2 class="text-lg text-darker">Trees Growing</h2>
        </div>
      </div>
    </div>
    <div class="p-8">
      <h1 class="text-2xl text-dark_active font-semibold mb-8">My Earnings</h1>
      ...
      <div class="flex justify-between">
        ...
        <h2 class="text-xl text-normal font-bold">P17,293</h2>
      </div>
      <div class="flex justify-between w-full py-6 gap-6">
        <button class="w-[50%] text-xl text-white bg-dark_active px-2 py-3 rounded-md flex gap-4 items-center justify-center">
          <img src="{{ asset('img/Transactions.png') }}" alt="" class="w-6">Transactions</button>
        <button class="w-[50%] text-xl text-white bg-dark_active px-4 py-4 rounded-md flex gap-4 items-center justify-center">
